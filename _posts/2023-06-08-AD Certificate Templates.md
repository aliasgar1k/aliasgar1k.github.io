...
tags: [active directory, active directory certificate service, ad cs, rubeus, mmc, pfx, kerberos, certutil, scp, runas]
image: assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115026.png
---
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115121.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115142.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115353.png)

- After a long time of searching we found following template which meet all of our conditions.

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115359.png)
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115403.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115430.png)

This will bring up the MMC window. In this window, click **File -> Add/Remove Snap-in…**

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115443.png)

In this window, you want to add the **Certificates** snap-in:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115501.png)

Although it will add the snap-in directly if you had administration privileged, you would see the next prompt:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115507.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115515.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115520.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115530.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115549.png)

We can then add these properties to our certificate:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115555.png)

When we click okay, we will now see that we are allowed to enroll this certificate:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115601.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115608.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115615.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115622.png)

Follow the prompts but make sure to export the private key as well:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115629.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115635.png)

Select a filename and export the certificate:

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115642.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115851.png)
...
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115923.png)
![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115928.png)

```
Rubeus.exe changepw /ticket:kerbtgt_svc_gitlab /new:Password1@ /dc:LUNDC.lunar.eruca.com /targetuser:lunar.eruca.com\da-nread
```

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115945.png)

```
runas /user:lunar.eruca.com\da-nread cmd.exe
```

![](assets/img/AD%20Certificate%20Templates/Pasted%20image%2020240619115957.png)
