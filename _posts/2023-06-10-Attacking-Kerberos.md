...
tags: [active directory, kerberos, kerberoasting, as-rep roasting, kerbrute, harvesting tickets,  password spraying, rubeus passtheticket,  golden ticket, skeleton key, impacket-getuserspns, mimikatz, kerberos backdoor]
image: assets/img/Attacking-Kerberos/Pasted%20image%2020240619111219.png
---
...
![](assets/img/Attacking-Kerberos/Pasted%20image%2020240619111310.png)
...
![](assets/img/Attacking-Kerberos/Pasted%20image%2020240619111319.png)
...
![](assets/img/Attacking-Kerberos/Pasted%20image%2020240619111331.png)
...
1. sekurlsa::tickets /export – this will export all of the .kirbi tickets into the directory that you are currently in. At this step you can also use the base 64 encoded tickets from Rubeus that we harvested earlier.
...
![](assets/img/Attacking-Kerberos/Pasted%20image%2020240619112430.png)

2.) Access machines that you want, what you can access will depend on the privileges of the user that you decided to take the ticket from however if you took the ticket from krbtgt you have access to the ENTIRE network hence the name golden ticket; however, silver tickets only have access to those that the user has access to if it is a domain admin it can almost access the entire network however it is slightly less elevated from a golden ticket.

![](assets/img/Attacking-Kerberos/Pasted%20image%2020240619112437.png)
...
- [https://www.youtube.com/watch?v=Nl_8WHcB5SM](https://www.youtube.com/watch?v=Nl_8WHcB5SM)
- [https://www.youtube.com/watch?v=lfosOfFfD_g&pp=ygUcYXR0YWNraW5nIGtlcmJlcm9zIHRyeWhhY2ttZQ%3D%3D](https://www.youtube.com/watch?v=lfosOfFfD_g&pp=ygUcYXR0YWNraW5nIGtlcmJlcm9zIHRyeWhhY2ttZQ%3D%3D)
